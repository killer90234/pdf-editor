...
export default function SignupModal() {
  const { showSignupModal, setShowSignupModal, setShowLoginModal, signUpWithEmail, signInWithGoogle, authError } = useAuthStore();
  ...
  return (
    <div style={styles.overlay} onClick={() => setShowSignupModal(false)}>
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <button style={styles.closeBtn} onClick={() => setShowSignupModal(false)}>&times;</button>
        <h2 style={styles.title}>Create Account</h2>
        <p style={styles.subtitle}>Sign up to get 3 free PDF edits</p>
        ...
        <p style={styles.switchText}>
          ...
          <button style={styles.switchBtn} onClick={switchToLogin}>Sign In</button>
        </p>
      </div>
    </div>
  );
